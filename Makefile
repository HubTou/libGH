...
SOURCES=src/${NAME}/__init__.py src/${NAME}/accounts.py src/${NAME}/common.py \
    src/${NAME}/libpnu2.py src/${NAME}/main.py src/${NAME}/organization_account.py \
    src/${NAME}/personal_account.py src/${NAME}/repositories.py
